...
<head>
	...
	<title>秒杀-正品秒杀！</title>
	<link rel="icon" href="/assets//static/seckill/img/favicon.ico">


    <link rel="stylesheet" type="text/css" href="/static/seckill/css/webbase.css" />
    <link rel="stylesheet" type="text/css" href="/static/seckill/css/widget-jquery.autocomplete.css" />
			...
			<div class="py-container">
				<div class="shortcut">
					...
					<ul class="fr">
						...
						<li class="f-item"><a href="seckillOrder.html" target="_blank">我的</a></li>
						<li class="f-item space"></li>
			...
			<div class="py-container">
				<div class="yui3-g Logo">
					<div class="yui3-u Left logoArea">
						<!-- <a class="logo-bd" title="购天下" href="JD-index.html" target="_blank"></a> -->
					</div>
...
<script type="text/javascript" src="/static/seckill/js/plugins/jquery/jquery.min.js"></script>
...
<script type="text/javascript" src="/static/seckill/js/plugins/sui/sui.min.js"></script>
<script type="text/javascript" src="/static/seckill/js/widget/jquery.autocomplete.js"></script>
<script type="text/javascript" src="/static/seckill/js/widget/nav.js"></script>
<script type="text/javascript" src="/static/seckill/js/pages/seckill-index.js"></script>
<script>
	   $(function(){
		   $("#code").hover(function(){
			   $(".erweima").show();
	...
	<div class="py-container index">
		...
		<div class="cd-top">
			...
			<div class="code" id="code">
				<span><img src="/static/seckill/img/_/code.png"/></span>
			</div>
			<div class="erweima">
...
<script>
     $('.seckilldo').click(function(){
         var goods_id="{{$v['goods_id']}}";
         $.post('http://2001.shop.api.com/seckilldo',{goods_id:goods_id},function(res){
			//未登录
            if(res.code=='1001'){
                alert(res.msg);
